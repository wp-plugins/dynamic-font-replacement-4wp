...
Description: Eigene Schriftarten mit Wordpress verwenden. SEO-freundlich, schnell, unkompliziert. Deutsche Version.
Version: 1.1 DE
								...
								<table width="100%" border="0" cellpadding="1" cellspacing="1" >
									<tbody>
										<tr>
											...
											<input type="submit" name="Submit" value="<?php _e('DFR aktivieren') ?>" />
											</form>
											</td>
											...
											<input type="submit" name="Submit" value="<?php _e('jsquery aktivieren*') ?>" />
											</form>
											</td>
